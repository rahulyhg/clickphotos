angular.module('phonecatControllers', ['templateservicemod', 'navigationservice', 'ui.bootstrap', 'ngSanitize', 'angular-flexslider', 'ui.swiper', 'imageupload', 'toastr', 'ui.select',
    ...
    .controller('VirtualGalleryCtrl', function ($scope, $rootScope, TemplateService, NavigationService, AddToCartSerivce, $timeout, $uibModal, $log, $state, CartService, toastr, $window, $cacheFactory, $location) {
        $log.log("in ctrl");
